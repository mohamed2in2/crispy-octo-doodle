...
export const PAYMENT_METHODS: readonly PaymentMethodConfig[] = [
  ...
  },
  {
    ...
    description: "ادفع بأمان باستخدام أي بطاقة خصم مباشر أو ائتمان محلية أو دولية (بوابة Sha7nawy).",
    category: "card",
    provider: "sha7nawy",
    brandColor: "#1A1F71",
    brandForeground: "#FFFFFF",
    ...
    instructions: [
      "سيتم تحويلك إلى بوابة الدفع البنكية المشفرة عبر Sha7nawy.",
  ...
  },
  {
    ...
    description: "ادفع بكل سهولة عبر بطاقة ميزة الوطنية الصادرة من أي بنك مصري (بوابة Sha7nawy).",
    category: "card",
    provider: "sha7nawy",
    brandColor: "#007A3D",
    brandForeground: "#FFFFFF",
