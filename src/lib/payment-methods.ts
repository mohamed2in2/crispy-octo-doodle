...
export const PAYMENT_METHODS: readonly PaymentMethodConfig[] = [
  ...
  },
  {
    ...
    requiresReference: false,
    available: true,
    processingSpeed: "تأكيد فوري عبر التطبيق",
    feePercentage: 2,
    minAmount: 5,
    maxAmount: 10000,
  ...
  {
    id: "or_cash",
    label: "أورانج كاش (Orange Cash)",
    labelEn: "Orange Cash Wallet",
    description: "ادفع فوراً من محفظة أورانج كاش عبر تطبيق Orange Cash.",
    category: "wallet",
    provider: "sha7nawy",
    brandColor: "#FF7900",
    brandForeground: "#FFFFFF",
    ...
    minAmount: 5,
    maxAmount: 10000,
    shortNote: "افتح تطبيق Orange Cash واقبل طلب الدفع المعلق فوراً",
    instructions: [
      "سيصلك إشعار بطلب الدفع المعلق على محفظتك خلال ثوانٍ.",
      "افتح تطبيق Orange Cash على هاتفك المحمول.",
      "اقبل طلب الدفع المعلق وأكد باستخدام الرقم السري للمحفظة.",
      "سيتم شحن رصيدك وتفعيل اشتراكك تلقائياً فور تأكيد الدفع.",
    ],
  },
  {
    id: "fawry",
