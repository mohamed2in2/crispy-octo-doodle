...
export const PAYMENT_METHODS: readonly PaymentMethodConfig[] = [
  ...
  /* ─── Shake-Out Gateway (dash.shake-out.com) ────────────────────────── */
  {
    ...
    instructions: [
      "سيصلك إشعار بطلب الدفع على رقم محفظتك أورانج كاش من بوابة Shake-Out.",
  ...
  },
  {
    ...
    description: "ادفع بأمان باستخدام أي بطاقة خصم مباشر أو ائتمان محلية أو دولية (بوابة Shake-Out).",
    category: "card",
    provider: "shakeout",
    brandColor: "#1A1F71",
    brandForeground: "#FFFFFF",
    ...
    instructions: [
      "سيتم تحويلك إلى بوابة الدفع البنكية المشفرة عبر Shake-Out.",
  ...
  },
  {
    ...
    description: "ادفع بكل سهولة عبر بطاقة ميزة الوطنية الصادرة من أي بنك مصري (بوابة Shake-Out).",
    category: "card",
    provider: "shakeout",
    brandColor: "#007A3D",
    brandForeground: "#FFFFFF",
    ...
    instructions: [
      "سيتم توجيهك لصفحة دفع ميزة الوطنية عبر Shake-Out.",
