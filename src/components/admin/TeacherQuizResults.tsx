  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center gap-3">
        <h2 className="text-xl font-black text-white">📝 نتائج الاختبارات</h2>
      ...
      <div className="flex flex-wrap gap-3">
        <select
          ...
          className="px-3 py-2 rounded-lg border border-gray-700 bg-gray-900 text-white text-sm"
        >
        ...
        <input
          ...
          className="flex-1 min-w-[200px] px-3 py-2 rounded-lg border border-gray-700 bg-gray-900 text-white text-sm"
        />
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {filtered.map((r) => (
            <div
              key={r.id}
              className="bg-gray-800 rounded-2xl border border-gray-700 p-4 flex items-center gap-4 flex-wrap"
            >
              {/* Student info */}
              ...
              <div className="min-w-[180px]">
                <p className="text-sm font-medium text-white">{r.quiz.title}</p>
                <p className="text-xs text-gray-400">{r.quiz.courseTitle} · {r.quiz.folderName}</p>
              </div>
