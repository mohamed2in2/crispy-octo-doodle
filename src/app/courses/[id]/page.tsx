                    ...
                    {payMode === "wallet" && (
                      <div className="p-3.5 rounded-xl space-y-3" style={{ background: "var(--surface-2)", border: "1px solid var(--border)" }}>
                        ...
                        <button onClick={async () => {
                          ...
                          {walletLoading ? "جارٍ إرسال طلب السحب..." : selectedWalletMethod === "or_cash" ? "أورنج كاش قيد الصيانة" : `خصم ${Math.round((course.effectivePrice * 1.02) * 100) / 100} جنيه من المحفظة 📱`}
                        </button>
