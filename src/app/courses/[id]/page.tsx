  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-950" dir="rtl">
      ...
      <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden">
        {course.thumbnailUrl && (
          <img src={course.thumbnailUrl} alt="" className="absolute inset-0 w-full h-full object-cover opacity-20" />
        )}
                    ...
                    {course.contactPhone && (
                      <a
                        href={buildWhatsAppUrl(
                          course.contactPhone,
                          `مرحباً مع ${course.teacher.name}، أريد الاشتراك في كورس "${course.title}" - ${STAGE_LABELS[course.educationalStage] || course.educationalStage}\nاسمي: ${user?.name ?? "..."}`,
                        )}
                        target="_blank"
