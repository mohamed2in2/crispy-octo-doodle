...
export default function PlansPage() {
  ...
  return (
    <ClassicShell title="الخطط الدراسية" balanceLabel="0 جنيه">
      <MotionConfig reducedMotion="user">
        <div className="flex flex-col min-h-screen" style={{ background: "transparent" }} dir="rtl">
          {!hasNoPlans && (
            <main className="flex-1 max-w-7xl mx-auto w-full px-2 sm:px-4 lg:px-6 py-6 md:py-8">
              {/* Header */}
              <motion.div
              ...
              >
                ...
                <h1 className="text-balance text-2xl md:text-3xl lg:text-4xl font-black tracking-tight mb-3" style={{ color: "var(--ink)", fontFamily: "var(--font-head)" }}>
                  الخطط الدراسية المنفذة بالمنصة
                </h1>
                <p className="text-sm max-w-2xl mx-auto leading-relaxed" style={{ color: "var(--ink-2)" }}>
