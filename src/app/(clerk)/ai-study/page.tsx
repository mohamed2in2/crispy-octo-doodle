            ...
            <div className="p-4 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50">
              <form onSubmit={handleSend} className="relative flex items-center gap-2">
                <input
                  ...
                  className="flex-1 bg-white dark:bg-[#151B2B] text-gray-900 dark:text-white rounded-2xl pl-14 pr-4 py-4 border border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-shadow shadow-sm"
                  disabled={loading || initialLoad}
                />
                <button
                  type="submit"
                  disabled={!input.trim() || loading || initialLoad}
                  className="absolute left-2 w-10 h-10 rounded-xl bg-gradient-to-br from-purple-600 to-indigo-600 text-white flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg hover:shadow-purple-500/25 transition-all"
                >
