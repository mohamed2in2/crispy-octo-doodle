  ...
  public buildContext(options: ContextOptions = {}): AIContext {
    const defaultContext: AIContext = {
      ...
      course: {
        ...
        subject: options.subject || "برمجه عملي",
      },
      lesson: {
        id: "lsn_101",
      ...
      quizHistory: [
        { quizId: "qz_100", quizTitle: "اختبار المقدمة", score: 90, date: new Date().toISOString() },
      ],
      homeworkStatus: {
        pendingCount: 1,
        completedCount: 4,
      ...
      studyPlan: {
        id: "plan_01",
        targetGoals: ["إتقان المتغيرات", "كتابة أول دالة"],
        currentModule: "الموديول الأول",
      },
      weakChapters: ["الدوال المتقدمة (Functions)", "المصفوفات (Arrays)"],
      strongChapters: ["المتغيرات (Variables)", "الجمل الشرطية (If Conditions)"],
